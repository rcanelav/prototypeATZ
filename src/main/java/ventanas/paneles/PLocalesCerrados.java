...
public class PLocalesCerrados extends PFondoStandard {
    ...
    private void colocarBotones(){
        ...
        rbEspectaculosDeportivos = new RadioBut("ESTABLECIMIENTO ESPECTACULOS DEPORTIVOS", 16);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource() == rbTeatro){
            ...
            JOptionPane.showMessageDialog(null, "LOCAL CERRADO - TEATRO - WIP");
