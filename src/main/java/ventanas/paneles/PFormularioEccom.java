...
public class PFormularioEccom extends JPanel implements FocusListener {
    ...
    private JTextField textoHabilitacion;
    private JTextField textoAlcanceCertificacion;
    ...
    private void formulario(){
        ...
        textoHabilitacion = new TextoFormulario();
        ...
        textoAlcanceCertificacion = new TextoFormulario();
    ...
    public void focusGained(FocusEvent e) {
        if(e.getSource() == textoCoberturaSeguro){
            textoCoberturaSeguro.setBorder(new LineBorder(Color.RED, 1));
