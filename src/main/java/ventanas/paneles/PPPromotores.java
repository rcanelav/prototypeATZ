...
public class PPPromotores extends JFrame {
  ...
  private void textFieldFocus(JTextField campoTexto) {                                     
    campoTexto.addFocusListener(new FocusListener() {
      @Override
      public void focusLost(FocusEvent e) {
          
        // campoTexto.setBackground(Color.red);
          verificarInput(campoTexto);
        }
      @Override
      public void focusGained(FocusEvent e) {
        textMobil.setBackground(Color.white);
      }
    });
  }
      
    private boolean verificarInput(JTextField input){
      
      // if(input.equals(textNif)){
